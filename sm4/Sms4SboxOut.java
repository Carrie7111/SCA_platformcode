...
@ModuleDesc(pkgName="SM4", name="SM4 S盒输出攻击分析", desc="", isVisible=true)
public class Sms4SboxOut extends DifferentialAnalysis implements ActionListener {
    ...
    public float[] select(Trace t) {
        ...
        for (int guess = 0; guess < 256; guess++) {
            long value = Sms4.t(sIn ^ BYTE_GUESS[guess]);
