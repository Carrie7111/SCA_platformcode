 ...
 */
public class Sms4RoundDefault extends Sms4RoundBase {
    ...
    public float[] GetMidDataHW(byte[] data) {
        ...
        for (int candidate = 0; candidate < CANDIDATES; candidate++) {
            long roundOut = u32(state[currentRound] ^ repeatByte(candidate));
            fillWordHammingWeight(midDataHw, candidate, roundOut);
        }
        return midDataHw;
    }
