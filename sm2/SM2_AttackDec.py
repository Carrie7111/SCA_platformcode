...
class SM2_AttackDec:
    """Python version of modules/sm2/SM2_AttackDec.java (core helpers)."""
    ...
    @staticmethod
    def GetM(cipher_hex: str, guessed_private_hex: str) -> Optional[str]:
        return recover_plaintext_from_guess(SM2_STD, cipher_hex, guessed_private_hex)
