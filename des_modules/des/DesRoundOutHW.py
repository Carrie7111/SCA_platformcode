...
class DesRoundOutHW:
    ...
    def initDialog(self):
        ...
        encryptGroup.append(self.encryptButton)
        ...
        encryptGroup.append(self.decryptButton)
        ...
        trackGroup.append(self.allButton)
        ...
        trackGroup.append(self.hwButton)
        ...
        roundGroup.append(self.round1Button)
        ...
        roundGroup.append(self.round2Button)
        ...
        keysGroup.append(self.twoKeysButton)
        ...
        keysGroup.append(self.threeKeysButton)
        ...
        targetGroup.append(self.sboxButton)
        ...
        targetGroup.append(self.xorButton)
        ...
        modelGroup.append(self.absButton)
        ...
        modelGroup.append(self.sButton)
        ...
        modelGroup.append(self.roundButton)
        ...
        desGroup.append(self.firstDesButton)
        ...
        desGroup.append(self.secondDesButton)
        ...
        desGroup.append(self.thirdDesButton)
    ...
    def _setDialogValuesInternal(self):
        ...
        if self.roundKey != 0:
            self.roundKeyVar.set(format(self.roundKey, 'x').upper())
        if self.desKey != 0:
            self.desKeyVar.set(format(self.desKey, 'x').upper())
        if self.des2Key != 0:
            self.des2KeyVar.set(format(self.des2Key, 'x').upper())
        if self.des3Key != 0:
            self.des3KeyVar.set(format(self.des3Key, 'x').upper())
        self.updateEnabledPanels()
    ...
    def _getKeyValues(self):
        ...
        if len(roundKeyString) > 0:
            ...
            try:
                self.roundKey = int(roundKeyString, 16)
                self.set(self.ROUND_KEY, self.roundKey)
            except ValueError:
                pass
    ...
    def select(self, t):
        attackObj = DesRoundOutHWDefault()
